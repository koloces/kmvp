...
public class TimeUtils {
    ...
    public static String getTimeStr(long otherTime, String format) {
        ...
        if (difference < 1000 * 60 * 60) {//小于半小时
            ...
            return String.valueOf(count) + BaseApplication.getInstance().getResources().getString(R.string.before_minute);
        }
        ...
        if (difference < 1000 * 60 * 60 * 24) {//一天之内
            ...
            return String.valueOf(count) + BaseApplication.getInstance().getResources().getString(R.string.before_hours);
        }

        if (difference < 1000 * 60 * 60 * 24 * 2) {//两天之内
            return BaseApplication.getInstance().getResources().getString(R.string.yesterday);
        }

        if (difference < 1000 * 60 * 60 * 24 * 3) {//两天之内
            return BaseApplication.getInstance().getResources().getString(R.string.before_yesterday);
        }
